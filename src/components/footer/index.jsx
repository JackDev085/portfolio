export default function Footer() {
    return (
        <footer id="footer" className="relative mt-20 w-full min-h-20 text-center bg-gray-900 pt-2">
             {/* <div className="text-gray-300 p-2">
                ...
                <div className="links flex gap-2 mt-2">
                    ...
                    <div className="relative link">
                        ...
                        <a className="absolute top-0 left-0 right-0 bottom-0" href="https://www.instagram.com/jackson.lorran/"></a>
                    </div>
                </div>
            </div> */}
            <p className="absolute bottom-6 left-0 right-0 text-gray-400">2025 | Jackson</p>
        </footer>
    );
}